    ...
    <?= GridView::widget([
        ...
        'columns'      => [
            ...
            [
              ...
              'buttons' => [
                'view' => function ($url) {
                    return Html::a('', $url, ['class' => 'glyphicon glyphicon-eye-open btn btn-default btn-xs custom_button', 'target' => '_blank']);
                },
                'update' => function ($url) {
                    return Html::a('', $url, ['class' => 'glyphicon glyphicon-pencil btn btn-default btn-xs custom_button', 'target' => '_blank']);
                },
                'delete' => function ($url) {
                    return Html::a('', $url, [
                        'class' => 'glyphicon glyphicon-remove btn btn-default btn-xs custom_button',
                        'data-method' => 'post',
                    ]);
                },
              ],
